...
class ParticleGunEcalHitStudy : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit ParticleGunEcalHitStudy(const edm::ParameterSet&);
   ...
   private:
      ...
      ECalHitHistogramContainer HistogramContainer;
};
...

{
   ...
   HistogramContainer.InitializeHistograms(file_service);
