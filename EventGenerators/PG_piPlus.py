...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:///home/guts/CMS/CMSSW_8_0_21/src/ParticleGunStudy/StudyFileCollection/TestSamples/events_piPlus.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    psethack = cms.string('single pi0 in each jet pt 20, 1.6 < eta < 2.3'),
)
